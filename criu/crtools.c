...
usage:
	...
	pr_msg("\n"
	       ...
	       "			    user:PID,UID,GID\n"
	       "  --enter-mntns\n"
	       "            When dumping, enter the mount namespace of the process\n"
	       "            before dumping.  CRIU will not capture the namespace in\n"
	       "            the image.\n"
	       "  --enter-pidns\n"
	       "            When dumping, enter the pid namespace of the process\n"
	       "            before dumping.  For this to work, --enter-mntns must\n"
	       "            also be specified and the child mount namespace must have\n"
	       "            /proc remounted to reflect the pids in the pid namespace.\n"
